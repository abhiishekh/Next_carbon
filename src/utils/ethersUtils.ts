...
export const offsetAgainstProject = async (amount: number, sourceCompany: string, sinkCompany: string, fromProject: string) => {
    try {
        const weiAmount = ethers.parseEther(amount.toString());
        const tx = await contract.offsetAgainstProject(weiAmount, sourceCompany, sinkCompany, fromProject);
